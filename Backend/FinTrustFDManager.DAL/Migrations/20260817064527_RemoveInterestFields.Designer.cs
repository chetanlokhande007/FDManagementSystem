...
namespace FinTrustFDManager.DAL.Migrations
{
    ...
    [Migration("20260817064527_RemoveInterestFields")]
    partial class RemoveInterestFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinTrustFDManager.Model.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2026, 8, 17, 6, 45, 25, 245, DateTimeKind.Utc).AddTicks(9496),
                            IsActive = true,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2026, 8, 17, 6, 45, 25, 245, DateTimeKind.Utc).AddTicks(9497),
                            IsActive = true,
                            RoleName = "CA"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2026, 8, 17, 6, 45, 25, 245, DateTimeKind.Utc).AddTicks(9499),
                            IsActive = true,
                            RoleName = "Approver"
                        });
                });
