...
namespace FinTrustFDManager.DAL.Migrations
{
    ...
    [Migration("20260828055016_AddBenchmarkRateHistory")]
    partial class AddBenchmarkRateHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinTrustFDManager.Model.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 50, 16, 172, DateTimeKind.Utc).AddTicks(2952),
                            IsActive = true,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 50, 16, 172, DateTimeKind.Utc).AddTicks(2953),
                            IsActive = true,
                            RoleName = "CA"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 50, 16, 172, DateTimeKind.Utc).AddTicks(2955),
                            IsActive = true,
                            RoleName = "Approver"
                        });
                });
