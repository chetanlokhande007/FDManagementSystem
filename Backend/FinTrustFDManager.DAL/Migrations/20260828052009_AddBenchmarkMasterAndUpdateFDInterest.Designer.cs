...
namespace FinTrustFDManager.DAL.Migrations
{
    ...
    [Migration("20260828052009_AddBenchmarkMasterAndUpdateFDInterest")]
    partial class AddBenchmarkMasterAndUpdateFDInterest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinTrustFDManager.Model.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 20, 7, 898, DateTimeKind.Utc).AddTicks(4135),
                            IsActive = true,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 20, 7, 898, DateTimeKind.Utc).AddTicks(4137),
                            IsActive = true,
                            RoleName = "CA"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2026, 8, 28, 5, 20, 7, 898, DateTimeKind.Utc).AddTicks(4138),
                            IsActive = true,
                            RoleName = "Approver"
                        });
                });
